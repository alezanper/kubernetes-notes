...
eksctl create iamserviceaccount \
  ...
  --attach-policy-arn=arn:aws:iam::805355762303:policy/AWSLoadBalancerControllerIAMPolicy \
  --approve
...
# Install app
kubectl apply -f simple-webapp-basic.yaml
kubectl apply -f simple-webapp-read-env.yaml
kubectl apply -f simple-webapp-ingress.yaml